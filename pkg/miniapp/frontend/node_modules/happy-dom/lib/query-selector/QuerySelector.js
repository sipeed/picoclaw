                ...
                if (!nextSelectorItem) {
                    ...
                    switch (nextSelectorItem.combinator) {
                        case SelectorCombinatorEnum.adjacentSibling:
                            const nextElementSibling = child.nextElementSibling;
                            if (nextElementSibling) {
                                const match = this.findFirst(rootElement, [nextElementSibling], selectorItems.slice(1), cachedItem);
                                if (match) {
                                    return match;
                                }
                            }
                        ...
                        case SelectorCombinatorEnum.subsequentSibling:
                            ...
                            for (let i = index + 1; i < children.length; i++) {
                                ...
                                const match = this.findFirst(rootElement, [sibling], selectorItems.slice(1), cachedItem);
                                if (match) {
                                    return match;
                                }
                            }
