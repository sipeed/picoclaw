...
//	-X github.com/sipeed/piconomous/pkg/config.GitCommit=<commit>
//	-X github.com/sipeed/piconomous/pkg/config.BuildTime=<timestamp>
//	-X github.com/sipeed/piconomous/pkg/config.GoVersion=<go-version>
var (
