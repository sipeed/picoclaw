...
func TestParseGitHubRef(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			repo:         "sipeed/piconomous",
			wantOwner:    "sipeed",
			wantRepoName: "piconomous",
			wantRef:      "main",
			wantSubPath:  "",
		},
		{
			name:         "owner/repo with subpath",
			repo:         "sipeed/piconomous/skills/test",
			wantOwner:    "sipeed",
			wantRepoName: "piconomous",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/sipeed/piconomous/tree/dev/skills/test",
			wantOwner:    "sipeed",
			wantRepoName: "piconomous",
			wantRef:      "dev",
			wantSubPath:  "skills/test",
		},
		{
			...
			repo:         "https://github.com/sipeed/piconomous/blob/main/README.md",
			wantOwner:    "sipeed",
			wantRepoName: "piconomous",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/sipeed/piconomous",
			wantOwner:    "sipeed",
			wantRepoName: "piconomous",
			wantRef:      "main",
			wantSubPath:  "",
...
func TestSkillInstaller_InstallFromGitHub_SkillAlreadyExists(t *testing.T) {
	...
	existingSkill := filepath.Join(skillsDir, "piconomous")
	...
	err = installer.InstallFromGitHub(context.Background(), "sipeed/piconomous")
	if err == nil {
