...
func (m *Manager) initChannels() error {
	...
	if m.config.Channels.WeCom.Enabled && m.config.Channels.WeCom.Token != "" {
		...
		wecom, err := NewWeComBotChannel(m.config.Channels.WeCom, m.config.Messages, m.bus)
		if err != nil {
	...
	if m.config.Channels.WeComApp.Enabled && m.config.Channels.WeComApp.CorpID != "" {
		...
		wecomApp, err := NewWeComAppChannel(m.config.Channels.WeComApp, m.config.Messages, m.bus)
		if err != nil {
