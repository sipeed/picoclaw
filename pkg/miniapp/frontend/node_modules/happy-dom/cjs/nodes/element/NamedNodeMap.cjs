...
class NamedNodeMap {
    ...
    getNamedItem(name) {
        ...
        if (this[PropertySymbol.ownerElement][PropertySymbol.namespaceURI] === NamespaceURI_js_1.default.html &&
            ...
            return this[PropertySymbol.namedItems].get(StringUtility_js_1.default.asciiLowerCase(name))?.[0] || null;
        }
    ...
    [PropertySymbol.setNamedItem](item, ignoreListeners = false) {
        ...
        this[PropertySymbol.namespaceItems].set(`${item[PropertySymbol.namespaceURI] || ''}:${item[PropertySymbol.localName]}`, item);
    ...
    [PropertySymbol.removeNamedItem](item, ignoreListeners = false) {
        ...
        this[PropertySymbol.namespaceItems].delete(`${item[PropertySymbol.namespaceURI] || ''}:${item[PropertySymbol.localName]}`);
        const namedItems = this[PropertySymbol.namedItems].get(item[PropertySymbol.name]);
        if (namedItems?.length) {
