		...
		ToolCalls: []providers.ToolCall{
			{
				...
				Function: &providers.FunctionCall{
					Name:      "web_search",
					Arguments: map[string]any{"query": "picoclaw agent framework", "max_results": float64(5)},
				},
			},
		},
	}
		...
		ToolCalls: []providers.ToolCall{
			{
				...
				Function: &providers.FunctionCall{
					Name:      "analyze",
					Arguments: map[string]any{"data": "sample", "depth": float64(3)},
				},
			},
		},
	}
			...
			ToolCalls: []providers.ToolCall{
				{
					...
					Function: &providers.FunctionCall{
						Name:      "tool_x",
						Arguments: map[string]any{"query": "test", "verbose": true},
					},
				},
			},
		},
