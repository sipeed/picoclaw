...
| [OVMS](https://docs.openvino.ai/2026/model-server/ovms_docs_llm_quickstart.html) | `ovms/` | 无需 | Intel OpenVINO Model Server，兼容 OpenAI |
...
<details>
<summary><b>本地部署（Ollama、vLLM、OVMS 等）</b></summary>
