...
func NewAgentInstance(
	...
	candidates := providers.ResolveCandidatesWithLookup(modelCfg, defaults.Provider, func(raw string) (string, bool) {
	...
	if rc := defaults.Routing; rc != nil && rc.Enabled && rc.LightModel != "" {
		...
		resolved := providers.ResolveCandidatesWithLookup(lightModelCfg, defaults.Provider, func(raw string) (string, bool) {
			return resolveFromModelList(cfg, raw)
		})
		if len(resolved) > 0 {
