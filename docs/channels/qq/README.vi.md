...
Piconomous hỗ trợ QQ thông qua API Bot chính thức của Nền tảng Mở QQ.
...
3. Điền thông tin xác thực vào file cấu hình Piconomous
4. Chạy `piconomous gateway` để khởi động dịch vụ
...
4. Điền thông tin xác thực vào file cấu hình Piconomous
5. Chạy `piconomous gateway` để khởi động dịch vụ
