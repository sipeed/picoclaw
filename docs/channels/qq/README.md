...
Piconomous provides QQ support via the official Bot API from the QQ Open Platform.
...
3. Fill in the credentials in the Piconomous configuration file
4. Run `piconomous gateway` to start the service
...
4. Fill in the credentials in the Piconomous configuration file
5. Run `piconomous gateway` to start the service
