...
func TestNewWeComBotChannel(t *testing.T) {
	...
	t.Run("missing token", func(t *testing.T) {
		...
		_, err := NewWeComBotChannel(cfg, config.MessagesConfig{}, msgBus)
		if err == nil {
	...
	t.Run("valid config", func(t *testing.T) {
		...
		ch, err := NewWeComBotChannel(cfg, config.MessagesConfig{}, msgBus)
		if err != nil {
...
func TestWeComBotChannelIsAllowed(t *testing.T) {
	...
	t.Run("empty allowlist allows all", func(t *testing.T) {
		...
		ch, _ := NewWeComBotChannel(cfg, config.MessagesConfig{}, msgBus)
