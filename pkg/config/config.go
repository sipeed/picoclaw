...
type NATSConfig struct {
	...
	EmbeddedHost      string   `json:"embedded_host" env:"PICOCLAW_SWARM_NATS_EMBEDDED_HOST"` // Embedded server listen address (0.0.0.0 for external access)
}
...
type TemporalConfig struct {
	...
	Model           string `json:"model" env:"PICOCLAW_SWARM_TEMPORAL_MODEL"` // LLM model for swarm tasks (e.g., glm-4, gpt-4, claude-sonnet-4-20250515)
}
