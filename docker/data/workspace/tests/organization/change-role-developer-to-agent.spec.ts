...
test('Change member role from Developer to Agent flow', async ({ page }) => {
  ...
  console.log('✅ Step 8: PASS - Agent role selected');
  ...
  console.log('✅ Step 12: PASS - Member role updated to Agent');
