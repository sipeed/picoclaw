...
import (
	...
	channels "github.com/sipeed/picoclaw/pkg/channels"
...
func TestEncryptDecrypt(t *testing.T) {
	...
	// Encrypt — type-assert to the webhook-mode channel to access unexported helper
	webhookCh, ok := ch.(*WeComAIBotChannel)
	if !ok {
		t.Fatal("Expected webhook-mode WeComAIBotChannel")
	}
