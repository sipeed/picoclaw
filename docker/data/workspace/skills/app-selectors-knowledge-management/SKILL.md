---
name: app-selectors-knowledge-management
description: DOM selectors and component map for the Knowledge Management page on dashboard.int3nt.info. Use when writing Playwright tests for this page.
---

# Knowledge Management — Component Map

> Generated: 2026-03-27T09:40:19.423Z
...
**Cards (1):**
- **Card 1** → `.main-container`
  "Add and manage your knowledge base files to customise your bot."
