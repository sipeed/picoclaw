...
import (
	...
	anthropicmessages "github.com/sipeed/piconomous/pkg/providers/anthropic_messages"
	"github.com/sipeed/piconomous/pkg/providers/azure"
)
...
func createCodexAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for openai. Run: piconomous auth login --provider openai")
	}
