...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.piconomous")
	assert.Equal(t, "/home/user/.piconomous/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.piconomous/workspace/file.txt", "/home/user/.piconomous")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".piconomous"), result)
}
