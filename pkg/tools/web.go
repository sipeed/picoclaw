...
const (
	...
	userAgentHonest = "piconomous/%s (+https://github.com/sipeed/piconomous; AI assistant bot)"
...
func (p *SearXNGSearchProvider) Search(ctx context.Context, query string, count int) (string, error) {
	...
	// Format results in standard Piconomous format
...
func (t *WebFetchTool) Execute(ctx context.Context, args map[string]any) *ToolResult {
	...
	// Retry once with an honest User-Agent that identifies piconomous, which some
