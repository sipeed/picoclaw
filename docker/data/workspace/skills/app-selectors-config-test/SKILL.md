---
name: app-selectors-config-test
description: DOM selectors and component map for the Config Test page on dashboard.int3nt.info. Use when writing Playwright tests for this page.
---

# Config Test — Component Map

> Generated: 2026-03-26T12:24:19.735Z
...
**Headings:**
- `h1` — "Please select a bot" (selector: `.select-bot-title`)
