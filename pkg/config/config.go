...
type AgentDefaults struct {
	...
	SteeringMode              string             `json:"steering_mode,omitempty"          env:"PICOCLAW_AGENTS_DEFAULTS_STEERING_MODE"`
	MaxParallelTurns          int                `json:"max_parallel_turns,omitempty"     env:"PICOCLAW_AGENTS_DEFAULTS_MAX_PARALLEL_TURNS"`
	SubTurn                   SubTurnConfig      `json:"subturn"                                                                                      envPrefix:"PICOCLAW_AGENTS_DEFAULTS_SUBTURN_"`
	ToolFeedback              ToolFeedbackConfig `json:"tool_feedback,omitempty"`
	SplitOnMarker             bool               `json:"split_on_marker"                  env:"PICOCLAW_AGENTS_DEFAULTS_SPLIT_ON_MARKER"`
...
type ExecConfig struct {
	...
	FilterEnv           bool     `                                 json:"filter_env"            env:"PICOCLAW_TOOLS_EXEC_FILTER_ENV"`
}
...
func (c *Config) MergeWorkspaceConfig(wc *WorkspaceConfig) error {
	...
	mergeRawJSONField(wc.rawJSON, "channel_list", &c.Channels)
