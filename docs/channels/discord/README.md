...
Discord is a free voice, video, and text chat application designed for communities. Piconomous connects to Discord servers via the Discord Bot API, supporting both receiving and sending messages.
