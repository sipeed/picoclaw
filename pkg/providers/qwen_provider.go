...
// QwenOAuthProvider implements LLMProvider using Alibaba Cloud DashScope API
...
// Chat implements LLMProvider.Chat using the DashScope OpenAI-compatible API.
...
// createQwenOAuthProviderFromStore creates a QwenOAuthProvider using stored credentials.
