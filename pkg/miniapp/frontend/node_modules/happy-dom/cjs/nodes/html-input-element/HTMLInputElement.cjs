...
class HTMLInputElement extends HTMLElement_js_1.default {
    ...
    [PropertySymbol.files] = new FileList_js_1.default();
    ...
    set value(value) {
        ...
        switch (this.type) {
            ...
            case 'file':
                if (value !== null && value !== '') {
                    throw new this[PropertySymbol.window].DOMException('Input elements of type "file" may only programmatically set the value to empty string.', DOMExceptionNameEnum_js_1.default.invalidStateError);
                }
                this[PropertySymbol.files] = new FileList_js_1.default();
                break;
            default:
    ...
    set selectionStart(start) {
        if (!this.#isSelectionSupported()) {
            throw new this[PropertySymbol.window].DOMException(`The input element's type (${this.type}) does not support selection.`, DOMExceptionNameEnum_js_1.default.invalidStateError);
        }
    ...
    set valueAsDate(value) {
        ...
        if (!['date', 'month', 'time', 'week'].includes(this.type)) {
            throw new this[PropertySymbol.window].DOMException("Failed to set the 'valueAsDate' property on 'HTMLInputElement': This input element does not support Date values.", DOMExceptionNameEnum_js_1.default.invalidStateError);
        }
    ...
    set valueAsNumber(value) {
        ...
        switch (this.type) {
            ...
            default:
                throw new this[PropertySymbol.window].DOMException("Failed to set the 'valueAsNumber' property on 'HTMLInputElement': This input element does not support Number values.", DOMExceptionNameEnum_js_1.default.invalidStateError);
        }
    }
    /**
