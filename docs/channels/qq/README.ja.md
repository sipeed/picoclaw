...
Piconomous は QQ オープンプラットフォームの公式 Bot API を通じて QQ をサポートします。
...
3. Piconomous 設定ファイルに認証情報を入力する
4. `piconomous gateway` を実行してサービスを起動する
...
4. Piconomous 設定ファイルに認証情報を入力する
5. `piconomous gateway` を実行してサービスを起動する
