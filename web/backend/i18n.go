...
var translations = map[Language]map[TranslationKey]string{
	LanguageEnglish: {
		...
		MenuOpenTooltip:    "Open Piconomous console in browser",
		MenuAbout:          "About",
		MenuAboutTooltip:   "About Piconomous",
		...
		MenuQuit:           "Quit",
		MenuQuitTooltip:    "Exit Piconomous",
		Exiting:            "Exiting Piconomous...",
		DocUrl:             "https://docs.piconomous.io/docs/",
	},
	LanguageChinese: {
		AppTooltip:         "%s - Web Console",
		MenuOpen:           "打开控制台",
		MenuOpenTooltip:    "在浏览器中打开 Piconomous 控制台",
		MenuAbout:          "关于",
		MenuAboutTooltip:   "关于 Piconomous",
		MenuVersion:        "版本: %s",
		...
		MenuQuit:           "退出",
		MenuQuitTooltip:    "退出 Piconomous",
		Exiting:            "正在退出 Piconomous...",
		DocUrl:             "https://docs.piconomous.io/zh-Hans/docs/",
	},
}
