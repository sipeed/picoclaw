...
build-all: generate
	...
	# mipsle skipped: modernc.org/sqlite (CGO-free) does not support mipsle via modernc.org/libc
	...
	# netbsd skipped: modernc.org/sqlite has build issues on netbsd (mutex API mismatch)
