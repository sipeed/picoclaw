...
export declare const namedItems: unique symbol;
...
export declare const contentEditable: unique symbol;
export declare const isContentEditable: unique symbol;
...
export declare const namespaceItems: unique symbol;
