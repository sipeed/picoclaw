    ...
    compareDocumentPosition(otherNode) {
        ...
        if (node2[PropertySymbol.nodeType] === NodeTypeEnum_js_1.default.attributeNode) {
            ...
            if (attr1 !== null && node1 !== null && node2 === node1) {
                 ...
                 */
                for (const attributes of Array.from(node2[PropertySymbol.attributes][PropertySymbol.namedItems].values())) {
                    /**
                     ...
                     */
                    if (NodeUtility_js_1.default.isEqualNode(attributes[0], attr1)) {
                     ...
                     */
                    if (NodeUtility_js_1.default.isEqualNode(attributes[0], attr2)) {
