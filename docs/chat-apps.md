...
Talk to your piconomous through Telegram, Discord, WhatsApp, Matrix, QQ, DingTalk, LINE, WeCom, Feishu, Slack, IRC, OneBot, MaixCam, or Pico (native protocol)
...
| **Pico**             | ⭐ Easy            | Native Piconomous protocol channel                      |                                                                                                                  |
...
4. Run `piconomous gateway` and open QQ to chat with your bot
...
* Configure as shown above and run `piconomous gateway`
...
Piconomous connects to Feishu via WebSocket/SDK mode — no public webhook URL or callback server needed.
...
OneBot is an open protocol for QQ bots. Piconomous connects to any OneBot v11 compatible implementation (e.g., [Lagrange](https://github.com/LagrangeDev/Lagrange.Core), [NapCat](https://github.com/NapNeko/NapCatQQ)) via WebSocket.
